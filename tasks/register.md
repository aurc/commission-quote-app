...
|-------|-----------------------------|-------------|----------------------------------------------------|
| CQ-01 | Design completeness pass    | in progress | `design/contract.md`, repaired `design/assumptions.md` |
| CQ-02 | Scaffold and platform       | todo        | `go.mod`, `Makefile`, `internal/platform`            |
